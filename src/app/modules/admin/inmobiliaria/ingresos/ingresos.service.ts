...
import { IngresosBrand, IngresosCategory, IngresosPagination, IngresosProduct, IngresosTag, IngresosVendor } from 'app/modules/admin/inmobiliaria/ingresos/ingresos.types';
...
export class IngresosService
{
    ...
    {
        return this._httpClient.get<IngresosBrand[]>('api/apps/inmobiliaria/ingresos/brands').pipe(
            tap((brands) =>
            {
    ...
    {
        return this._httpClient.get<IngresosCategory[]>('api/apps/inmobiliaria/ingresos/categories').pipe(
            tap((categories) =>
            {
    ...
    {
        return this._httpClient.get<{ pagination: IngresosPagination; products: IngresosProduct[] }>('api/apps/inmobiliaria/ingresos/products', {
            params: {
                page: '' + page,
                size: '' + size,
                sort,
    ...
    createProduct(): Observable<IngresosProduct>
    {
        return this.products$.pipe(
            take(1),
            switchMap(products => this._httpClient.post<IngresosProduct>('api/apps/inmobiliaria/ingresos/product', {}).pipe(
                map((newProduct) =>
                {
    ...
    updateProduct(id: string, product: IngresosProduct): Observable<IngresosProduct>
    {
        return this.products$.pipe(
            take(1),
            switchMap(products => this._httpClient.patch<IngresosProduct>('api/apps/inmobiliaria/ingresos/product', {
                id,
                product,
            }).pipe(
                map((updatedProduct) =>
    ...
    deleteProduct(id: string): Observable<boolean>
    {
        return this.products$.pipe(
            take(1),
            switchMap(products => this._httpClient.delete('api/apps/inmobiliaria/ingresos/product', {params: {id}}).pipe(
    ...
    {
        return this._httpClient.get<IngresosTag[]>('api/apps/inmobiliaria/ingresos/tags').pipe(
            tap((tags) =>
            {
    ...
    createTag(tag: IngresosTag): Observable<IngresosTag>
    {
        return this.tags$.pipe(
            take(1),
            switchMap(tags => this._httpClient.post<IngresosTag>('api/apps/inmobiliaria/ingresos/tag', {tag}).pipe(
                map((newTag) =>
                {
    ...
    updateTag(id: string, tag: IngresosTag): Observable<IngresosTag>
    {
        return this.tags$.pipe(
            take(1),
            switchMap(tags => this._httpClient.patch<IngresosTag>('api/apps/inmobiliaria/ingresos/tag', {
                id,
                tag,
            }).pipe(
                map((updatedTag) =>
    ...
    deleteTag(id: string): Observable<boolean>
    {
        return this.tags$.pipe(
            take(1),
            switchMap(tags => this._httpClient.delete('api/apps/inmobiliaria/ingresos/tag', {params: {id}}).pipe(
                map((isDeleted: boolean) =>
                {
    ...
    {
        return this._httpClient.get<IngresosVendor[]>('api/apps/inmobiliaria/ingresos/vendors').pipe(
            tap((vendors) =>
            {
