...
@Component({
    selector: 'margesi-delosdatostecnicos-linderos',
    templateUrl: './linderos.component.html',
  ...
  export class DelosDatosTecnicosLinderosMargesi{
    datosAspectosTecnicosLinderosForm: UntypedFormGroup;
    _formBuilder = inject(FormBuilder);

    ngOnInit(): void
    {
        this.datosAspectosTecnicosLinderosForm = this._formBuilder.group({
            linderos: [],
