...
@Component({
    selector: 'margesi-itls-antecedentes-del-fiador',
  ...
  export class DelosDatosITLAntecedentesDelFiador{
    delosDatosITLAntecedentesDelFiador: UntypedFormGroup;
    _formBuilder = inject(FormBuilder);

    ngOnInit(): void
    {
        this.delosDatosITLAntecedentesDelFiador = this._formBuilder.group({
            archivo: [],
            nro_doc: [],
            nombre_completo: [],
            direccion: [],
