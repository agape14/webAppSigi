...
@Component({
    selector       : 'Expconta-list',
    templateUrl    : './expconta.component.html',
    styles         : [
        /* language=SCSS */
        `
...
export class ExpcontaComponent implements OnInit, AfterViewInit, OnDestroy
{
    myForm: FormGroup;
    ...
    products$: Observable<ExpcontaProduct[]>;
    iconSize: string = 'icon-size-8';
    contactsCount: number = 0;
    brands: ExpcontaBrand[];
    categories: ExpcontaCategory[];
    filteredTags: ExpcontaTag[];
    flashMessage: 'success' | 'error' | null = null;
    isLoading: boolean = false;
    pagination: ExpcontaPagination;
    searchInputControl: UntypedFormControl = new UntypedFormControl();
    selectedProduct: ExpcontaProduct | null = null;
    selectedProductForm: FormGroup;
    tags: ExpcontaTag[];
    tagsEditMode: boolean = false;
    vendors: ExpcontaVendor[];
    ...
    constructor(
        ...
        private _ExpcontaService: ExpcontaService,
    ...
    ngOnInit(): void
    {
        ...
        // Get the brands
        this._ExpcontaService.brands$
            .pipe(takeUntil(this._unsubscribeAll))
            .subscribe((brands: ExpcontaBrand[]) =>
            {
                // Update the brands
                this.brands = brands;
        ...
        // Get the categories
        this._ExpcontaService.categories$
            .pipe(takeUntil(this._unsubscribeAll))
            .subscribe((categories: ExpcontaCategory[]) =>
            {
        ...
        // Get the pagination
        this._ExpcontaService.pagination$
            .pipe(takeUntil(this._unsubscribeAll))
            .subscribe((pagination: ExpcontaPagination) =>
            {
        ...
        // Get the products
        this.products$ = this._ExpcontaService.products$;

        // Get the tags
        this._ExpcontaService.tags$
            .pipe(takeUntil(this._unsubscribeAll))
            .subscribe((tags: ExpcontaTag[]) =>
            {
                // Update the tags
                this.tags = tags;
        ...
        // Get the vendors
        this._ExpcontaService.vendors$
            .pipe(takeUntil(this._unsubscribeAll))
            .subscribe((vendors: ExpcontaVendor[]) =>
            {
                // Update the vendors
        ...
        this.searchInputControl.valueChanges
            .pipe(
                ...
                switchMap((query) =>
                {
                    this.closeDetails();
                    this.isLoading = true;
                    return this._ExpcontaService.getProducts(0, 10, 'name', 'asc', query);
                }),
                map(() =>
                {
        ...
        if ( this._sort && this._paginator )
        {
            ...
            merge(this._sort.sortChange, this._paginator.page).pipe(
                switchMap(() =>
                {
                    this.closeDetails();
                    this.isLoading = true;
                    return this._ExpcontaService.getProducts(this._paginator.pageIndex, this._paginator.pageSize, this._sort.active, this._sort.direction);
                }),
                map(() =>
                {
                    this.isLoading = false;
    ...
    toggleDetails(productId: string): void
    {
        ...
        this._ExpcontaService.getProductById(productId)
            .subscribe((product) =>
            {
    ...
    createTag(title: string): void
    {
        ...
        this._ExpcontaService.createTag(tag)
            .subscribe((response) =>
            {
     ...
     * @param event
     */
    updateTagTitle(tag: ExpcontaTag, event): void
    {
        // Update the title on the tag
        tag.title = event.target.value;

        // Update the tag on the server
        this._ExpcontaService.updateTag(tag.id, tag)
     ...
     * @param tag
     */
    deleteTag(tag: ExpcontaTag): void
    {
        // Delete the tag from the server
        this._ExpcontaService.deleteTag(tag.id).subscribe();
     ...
     * @param tag
     */
    addTagToProduct(tag: ExpcontaTag): void
    {
        // Add the tag
     ...
     * @param tag
     */
    removeTagFromProduct(tag: ExpcontaTag): void
    {
        // Remove the tag
     ...
     * @param change
     */
    toggleProductTag(tag: ExpcontaTag, change: MatCheckboxChange): void
    {
        if ( change.checked )
        {
            this.addTagToProduct(tag);
    ...
    {
        // Create the product
        this._ExpcontaService.createProduct().subscribe((newProduct) =>
        {
            // Go to new product
    ...
    updateSelectedProduct(): void
    {
        ...
        this._ExpcontaService.updateProduct(product.id, product).subscribe(() =>
        {
    ...
    deleteSelectedProduct(): void
    {
        ...
        confirmation.afterClosed().subscribe((result) =>
        {
            ...
            if ( result === 'confirmed' )
            {
                ...
                this._ExpcontaService.deleteProduct(product.id).subscribe(() =>
                {
                    // Close the details
                    this.closeDetails();
                });
