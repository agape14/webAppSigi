...
export class BancosComponent implements OnInit, AfterViewInit, OnDestroy
{
    ...
    products$: Observable<BancosProduct[]>;
    iconSize: string = 'icon-size-8';
    contactsCount: number = 0;
    brands: BancosBrand[];
    categories: BancosCategory[];
    filteredTags: BancosTag[];
    flashMessage: 'success' | 'error' | null = null;
    isLoading: boolean = false;
    pagination: BancosPagination;
    searchInputControl: UntypedFormControl = new UntypedFormControl();
    selectedProduct: BancosProduct | null = null;
    selectedProductForm: FormGroup;
    tags: BancosTag[];
    tagsEditMode: boolean = false;
    vendors: BancosVendor[];
    ...
    ngOnInit(): void
    {
        ...
        // Get the brands
        this._BancosService.brands$
            .pipe(takeUntil(this._unsubscribeAll))
            .subscribe((brands: BancosBrand[]) =>
            {
                // Update the brands
                this.brands = brands;
        ...
        // Get the categories
        this._BancosService.categories$
            .pipe(takeUntil(this._unsubscribeAll))
            .subscribe((categories: BancosCategory[]) =>
            {
        ...
        // Get the pagination
        this._BancosService.pagination$
            .pipe(takeUntil(this._unsubscribeAll))
            .subscribe((pagination: BancosPagination) =>
            {
        ...
        // Get the products
        this.products$ = this._BancosService.products$;

        // Get the tags
        this._BancosService.tags$
            .pipe(takeUntil(this._unsubscribeAll))
            .subscribe((tags: BancosTag[]) =>
            {
                // Update the tags
                this.tags = tags;
        ...
        // Get the vendors
        this._BancosService.vendors$
            .pipe(takeUntil(this._unsubscribeAll))
            .subscribe((vendors: BancosVendor[]) =>
            {
                // Update the vendors
        ...
        this.searchInputControl.valueChanges
            .pipe(
                ...
                switchMap((query) =>
                {
                    this.closeDetails();
                    this.isLoading = true;
                    return this._BancosService.getProducts(0, 10, 'name', 'asc', query);
                }),
                map(() =>
                {
        ...
        if ( this._sort && this._paginator )
        {
            ...
            merge(this._sort.sortChange, this._paginator.page).pipe(
                switchMap(() =>
                {
                    this.closeDetails();
                    this.isLoading = true;
                    return this._BancosService.getProducts(this._paginator.pageIndex, this._paginator.pageSize, this._sort.active, this._sort.direction);
                }),
                map(() =>
                {
                    this.isLoading = false;
    ...
    toggleDetails(productId: string): void
    {
        ...
        this._BancosService.getProductById(productId)
            .subscribe((product) =>
            {
    ...
    createTag(title: string): void
    {
        ...
        this._BancosService.createTag(tag)
            .subscribe((response) =>
            {
     ...
     * @param event
     */
    updateTagTitle(tag: BancosTag, event): void
    {
        // Update the title on the tag
        tag.title = event.target.value;

        // Update the tag on the server
        this._BancosService.updateTag(tag.id, tag)
     ...
     * @param tag
     */
    deleteTag(tag: BancosTag): void
    {
        // Delete the tag from the server
        this._BancosService.deleteTag(tag.id).subscribe();
     ...
     * @param tag
     */
    addTagToProduct(tag: BancosTag): void
    {
        // Add the tag
     ...
     * @param tag
     */
    removeTagFromProduct(tag: BancosTag): void
    {
        // Remove the tag
     ...
     * @param change
     */
    toggleProductTag(tag: BancosTag, change: MatCheckboxChange): void
    {
        if ( change.checked )
        {
            this.addTagToProduct(tag);
    ...
    {
        // Create the product
        this._BancosService.createProduct().subscribe((newProduct) =>
        {
            // Go to new product
    ...
    updateSelectedProduct(): void
    {
        ...
        this._BancosService.updateProduct(product.id, product).subscribe(() =>
        {
    ...
    deleteSelectedProduct(): void
    {
        ...
        confirmation.afterClosed().subscribe((result) =>
        {
            ...
            if ( result === 'confirmed' )
            {
                ...
                this._BancosService.deleteProduct(product.id).subscribe(() =>
                {
                    // Close the details
                    this.closeDetails();
                });
