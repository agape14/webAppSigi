...
export class MotivosComponent implements OnInit, AfterViewInit, OnDestroy
{
    ...
    products$: Observable<MotivosProduct[]>;
    iconSize: string = 'icon-size-8';
    contactsCount: number = 0;
    brands: MotivosBrand[];
    categories: MotivosCategory[];
    filteredTags: MotivosTag[];
    flashMessage: 'success' | 'error' | null = null;
    isLoading: boolean = false;
    pagination: MotivosPagination;
    searchInputControl: UntypedFormControl = new UntypedFormControl();
    selectedProduct: MotivosProduct | null = null;
    selectedProductForm: FormGroup;
    tags: MotivosTag[];
    tagsEditMode: boolean = false;
    vendors: MotivosVendor[];
    ...
    ngOnInit(): void
    {
        ...
        // Get the brands
        this._motivosService.brands$
            .pipe(takeUntil(this._unsubscribeAll))
            .subscribe((brands: MotivosBrand[]) =>
            {
                // Update the brands
                this.brands = brands;
        ...
        // Get the categories
        this._motivosService.categories$
            .pipe(takeUntil(this._unsubscribeAll))
            .subscribe((categories: MotivosCategory[]) =>
            {
        ...
        // Get the pagination
        this._motivosService.pagination$
            .pipe(takeUntil(this._unsubscribeAll))
            .subscribe((pagination: MotivosPagination) =>
            {
        ...
        // Get the products
        this.products$ = this._motivosService.products$;

        // Get the tags
        this._motivosService.tags$
            .pipe(takeUntil(this._unsubscribeAll))
            .subscribe((tags: MotivosTag[]) =>
            {
                // Update the tags
                this.tags = tags;
        ...
        // Get the vendors
        this._motivosService.vendors$
            .pipe(takeUntil(this._unsubscribeAll))
            .subscribe((vendors: MotivosVendor[]) =>
            {
                // Update the vendors
        ...
        this.searchInputControl.valueChanges
            .pipe(
                ...
                switchMap((query) =>
                {
                    this.closeDetails();
                    this.isLoading = true;
                    return this._motivosService.getProducts(0, 10, 'name', 'asc', query);
                }),
                map(() =>
                {
        ...
        .subscribe((data) =>
        {
            // Verificar si data no es null o undefined - Motivos
            if (data) {
                // Store the data
                this.data = data;
        ...
        if ( this._sort && this._paginator )
        {
            ...
            merge(this._sort.sortChange, this._paginator.page).pipe(
                switchMap(() =>
                {
                    this.closeDetails();
                    this.isLoading = true;
                    return this._motivosService.getProducts(this._paginator.pageIndex, this._paginator.pageSize, this._sort.active, this._sort.direction);
                }),
                map(() =>
                {
                    this.isLoading = false;
    ...
    toggleDetails(productId: string): void
    {
        ...
        this._motivosService.getProductById(productId)
            .subscribe((product) =>
            {
    ...
    createTag(title: string): void
    {
        ...
        this._motivosService.createTag(tag)
            .subscribe((response) =>
            {
     ...
     * @param event
     */
    updateTagTitle(tag: MotivosTag, event): void
    {
        // Update the title on the tag
        tag.title = event.target.value;

        // Update the tag on the server
        this._motivosService.updateTag(tag.id, tag)
     ...
     * @param tag
     */
    deleteTag(tag: MotivosTag): void
    {
        // Delete the tag from the server
        this._motivosService.deleteTag(tag.id).subscribe();
     ...
     * @param tag
     */
    addTagToProduct(tag: MotivosTag): void
    {
        // Add the tag
     ...
     * @param tag
     */
    removeTagFromProduct(tag: MotivosTag): void
    {
        // Remove the tag
     ...
     * @param change
     */
    toggleProductTag(tag: MotivosTag, change: MatCheckboxChange): void
    {
        if ( change.checked )
        {
            this.addTagToProduct(tag);
    ...
    {
        // Create the product
        this._motivosService.createProduct().subscribe((newProduct) =>
        {
            // Go to new product
    ...
    updateSelectedProduct(): void
    {
        ...
        this._motivosService.updateProduct(product.id, product).subscribe(() =>
        {
    ...
    deleteSelectedProduct(): void
    {
        ...
        confirmation.afterClosed().subscribe((result) =>
        {
            ...
            if ( result === 'confirmed' )
            {
                ...
                this._motivosService.deleteProduct(product.id).subscribe(() =>
                {
                    // Close the details
                    this.closeDetails();
                });
